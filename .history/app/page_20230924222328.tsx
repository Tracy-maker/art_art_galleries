  ...
  return (
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      <div className="space-y-2 pt-5 pb-8 md:space-x-5">
        <h6 className="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-13">
        Greetings, dear art enthusiast! Come forth and join me at the canvas of curiosity, where strokes of inspiration meld with the vibrant palette of imagination. Here, I offer you a delightful selection of oil paintings, each imbued with its own unique charm, a visual feast for your discerning eyes.

Ah, but that's not all! My humble abode also hosts a blog, a repository of musings and insights infused with the whimsy and wit that only an artist's perspective can provide. It's a veritable treasure trove of art-related humor, a place where we can indulge in a bit of artistic banter.
        </h6>
      </div>
