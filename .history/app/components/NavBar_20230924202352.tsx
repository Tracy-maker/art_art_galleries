              ...
              <div className="flex justify-between w-full">
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8 sm:items-center">
                  ...
                  <Link
                    ...
                    className={`${
                      pathname === "/galleries"
                        ? "border-blue-400 h-full inline-flex items-center px-1  border-b-2 text-lg font-medium"
                        : "border-transparent text-gray-500 inline-flex items-center px-1  border-b-2 text-lg font-medium"
                    }`}
                  >
                    GALLERIES
                  </Link>
